...
nodejs (note: the version in Ubuntu sources is out of date; this script should automatically add a more up to date PPA on Ubuntu, but not tested against other distributions)
